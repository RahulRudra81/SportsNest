...
export default function Home() {
  return (
    ...
    <div className="text-container max-w-2xl mx-auto px-4">
      <p className="text-4xl font-mono md:text-6xl font-bold mb-5">Welcome to <br/> Sports Nest</p>
      <p className="text-lg font-mono md:text-xl mb-8">This is where you'll find amazing content to Dive in and explore!</p>
      <a href="/create-blog" className="bg-[#222831] hover:bg-[#393E46] text-white font-bold py-3 px-6 rounded-lg text-lg">Add New Event</a>
    </div>
    {/* Image on one side */}
